		  ...
		  struct pt_regs *regs)
{
	...
	printcrash(" Unable to handle kernel %s at virtual address %08lx\n",
...
#ifdef CONFIG_PANTECH_ERR_CRASH_LOGGING
		printcrash(" USER %s: unhandled page fault (%d) at 0x%08lx, code 0x%03x\n",
...
#ifdef CONFIG_PANTECH_ERR_CRASH_LOGGING
	printcrash(" Unhandled fault: %s (0x%03x) at 0x%08lx\n",
		inf->name, fsr, addr);
#endif
