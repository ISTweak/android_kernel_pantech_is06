...
#include <mach/rpc_server_handset.h>
		...
		defined(CONFIG_SENSORS_YAS529) || \
		defined(CONFIG_SENSORS_GP2AP002S00F) )
#define CONFIG_SENSORS_I2C_GPIO
#endif
...
#ifdef CONFIG_CMA3000
#include <linux/i2c/cma3000.h>
#endif

#if defined(CONFIG_SKYCAM_MV9335) || defined(CONFIG_SKY_TDMB_I2C_GPIO) || defined(CONFIG_SENSORS_I2C_GPIO)
...
#include "./qdsp6/skysnd_max9877.h"
#endif

#ifdef CONFIG_PMIC_VIBRATOR // shpark 100510
...
#ifdef CONFIG_EF12_BOARD
#define MSM_PMEM_MMP_SIZE 0x600000  // 20091106 KKS : MMP_NEX_PMEM -> 2010.04.06 3M->6M KSG[DS3]
#define MSM_PMEM_TDMB_SIZE 0x100000  // 20091126 KKS : PV_TDMB_SURFACE

#ifdef SKY_SCREEN_CAPTURE_API
#define MSM_PMEM_PPP_SIZE 0x100000  // 20100113 KSG : PMEM_ADD 01.18 3M->1M
#endif

#ifdef SKY_USE_HDMI
#define MSM_PMEM_HDMI_SIZE 0x1D0000  // 20100403 KSG : PMEM_HDMI_ADD
#endif
...
#ifdef CONFIG_SENSORS_I2C_GPIO
#define GPIO_PIN_SENSOR_SCL	29
#define GPIO_PIN_SENSOR_SDA	83
...
#ifdef CONFIG_SKYSND_USE_EXTAMP
#define AUDIO_I2C_SCL_GPIO 145
#define AUDIO_I2C_SDA_GPIO 146
static struct i2c_gpio_platform_data audio_i2c_gpio_data = {
	.scl_pin = AUDIO_I2C_SCL_GPIO,
	.sda_pin = AUDIO_I2C_SDA_GPIO,
	.udelay = 2, /* 250KHz */
};
struct platform_device msm_device_i2c_gpio_audio = {
	.name = "i2c-gpio",
	.id = 3,
	.dev = {
		.platform_data = &audio_i2c_gpio_data,
	}
};
#endif


#ifdef CONFIG_SKYCAM_MV9335
#define GPIO_PIN_CAMERA_SCL	1
#define GPIO_PIN_CAMERA_SDA	2
...
#if ((MODEL_ID == MODEL_EF12) || (MODEL_ID == MODEL_JMASAI))
	.nluns          = 0x01,
#else
	.nluns          = 0x02,
#endif
...
#ifdef CONFIG_ANDROID_PANTECH_HSUSB
	{
		/* MODEM + DIAG + OBEX + MSC*/
		.product_id     = 0x6021,
		.functions      = 0x2C46,      
    	.adb_product_id = 0x6021,
    	.adb_functions  = 0x21C46, 
	},
	{
		/* RNDIS */
		.product_id     = 0x6023,	
		.functions      = 0xA,		
		.adb_product_id = 0x6023,
		.adb_functions  = 0x1A,
	}
#endif
// 20100920 YGP for Pantech USB Driver porting ========<
...
#if defined(CONFIG_ANDROID_PANTECH_HSUSB)
...
static struct msm_hsusb_platform_data msm_hsusb_pdata = {
	...
	.vendor_id          = 0x10A9,
	.product_name       = SKY_MODEL_NAME,//"SKY(OBEX) USB MODEM",
	.serial_number      = NULL,//"EF10SBSN",
	.manufacturer_name  = "SKY",
	.compositions	= usb_func_composition,
	.num_compositions = ARRAY_SIZE(usb_func_composition),
	...
	.phy_info	= (USB_PHY_INTEGRATED | USB_PHY_MODEL_180NM),
	.vendor_id          = 0x10A9,
	.product_name       = SKY_MODEL_NAME, //"SKY USB MODEM",
	.serial_number      = NULL,
	.manufacturer_name  = "SKY",
	.compositions	= usb_func_composition,
	.num_compositions = ARRAY_SIZE(usb_func_composition),
...
#ifdef CONFIG_EF12_BOARD
// 20100826 jjangu_device : MMP_NEX_PMEM
static struct android_pmem_platform_data android_pmem_mmp_pdata = {
	.name = "pmem_mmp",
	.allocator_type = PMEM_ALLOCATORTYPE_BITMAP,
	.cached = 1,
};

// 20100113 KSG : PMEM_ADD
#ifdef SKY_SCREEN_CAPTURE_API
static struct android_pmem_platform_data android_pmem_ppp_pdata = {
	.name = "pmem_ppp",
	.allocator_type = PMEM_ALLOCATORTYPE_BITMAP,
	.cached = 1,
};
...
#ifdef CONFIG_EF12_BOARD
// 20100826 jjangu_device : MMP_NEX_PMEM
static struct platform_device android_pmem_mmp_device = {
	.name = "android_pmem",
	.id = 4,
	.dev = { .platform_data = &android_pmem_mmp_pdata },
};
...
#ifndef SKY_LCDC_IC_CONTROL
// lsb 090716 : to avoid system halt, decrease spi clock from 10M to 1Khz. 
//              on 10Mhz, panel is freezed. --;
//              in 3130(?) 1Mhz is OK but failed in 3145.
// 			    maybe you need to adjust this clock value
static struct spi_board_info msm_spi_board_info[] __initdata = {
	{
		...
		.chip_select	= 0,
		.max_speed_hz	= 10000,
		.platform_data	= NULL,//&bma_pdata,
	},

#ifdef CONFIG_INPUT_OJNAVI
	{
		.modalias	= "ojnavi",
		.mode		= SPI_MODE_3,
		.irq		= MSM_GPIO_TO_INT(157),
		.bus_num	= 0,
		.chip_select	= 1,
		.max_speed_hz	= 1000000,
		.platform_data	= NULL,//&bma_pdata,
		// It is not possible configure clk_speed as 1MHz under.
	}
#endif
};
#else
...
static struct msm_gpio qsd_spi_gpio_config_data[] = {
#if 0 //20100507 choiseulkee chg, SPI gpio configuration
	...
	{ GPIO_CFG(19, 1, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA), "spi_miso" },
	{ GPIO_CFG(20, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_2MA), "spi_cs0" },
	{ GPIO_CFG(21, 1, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA), "spi_cs1" },
#endif
};
...
#ifndef CONFIG_SKYSND_USE_EXTAMP
	{
		.name   = "sdac_din",
		.start  = 144,
		.end    = 144,
...
static struct resource bluesleep_resources[] = {
        ...
        {
                .name   = "host_wake",
                .start  = MSM_GPIO_TO_INT(22),
                .end    = MSM_GPIO_TO_INT(22),
                .flags  = IORESOURCE_IRQ,
        },
};
#else /* CONFIG_SWB_A22_BT */
static struct resource bluesleep_resources[] = {
	{
		.name	= "gpio_host_wake",
		.start	= 21,
...
static struct msm_gpio bt_config_power_off[] = {
	{ GPIO_CFG(36, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA),
		"BT SYSRST" },
	{ GPIO_CFG(106, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA),
		"BT WAKE" },
...
static struct msm_gpio bt_config_power_on[] = {
	{ GPIO_CFG(36, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),
		"BT SYSRST" },
	{ GPIO_CFG(106, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),
		"BT WAKE" },
	{ GPIO_CFG(22, 0, GPIO_INPUT,  GPIO_NO_PULL, GPIO_2MA),
		"HOST WAKE" },
#ifndef CONFIG_EF12_BOARD
	{ GPIO_CFG(21, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA),
		"BT VDD_IO" },
#endif
...
#ifdef CONFIG_SWB_A22_WLAN
#define PANTECH_POWER_AR6000_MSM
#if (BOARD_VER == EF12_WS10)
int wlan_vbatt_switch(int onoff);
#elif (BOARD_VER >= EF12_WS20)
int wlan_1p2V_A23_switch(int onoff);
#endif
int bt_enabled;
int wifi_enabled;
...
static struct msm_gpio wlan_config_power_on[] = {
	{ GPIO_CFG(141, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA),
		"WLAN_PWD" }
};
#else
...
#endif /* CONFIG_SWB_A22_WLAN */

#ifdef CONFIG_SWB_A22_BT
static int swb_a23_bt_power(int on)
{
        int rc = 0;

#ifdef CONFIG_EF10_TG10
        struct vreg *vreg_msme2;
#endif
#ifdef CONFIG_EF10_TG10
        vreg_msme2 = vreg_get(0, "msme2");
#endif /* CONFIG_EF10_TG10 */

        if (on) {
                printk(KERN_INFO "%s : %d\n", __func__, on);

#ifdef CONFIG_EF10_TG10
                //VREG_MSME2 : 1.2V_A22_PM
...
static int bluetooth_power(int on)
{
    ...
    ret = pmic_lp_mode_control(on ? OFF_CMD : ON_CMD, PM_VREG_LP_MSMP_ID);
	if (ret)
		printk(KERN_ERR "%s: pmic_lp_mode_control failed!\n", __func__);
	...
	if (rc < 0) {
       ...
       gpio_set_value(36, on); /* BT_SYSRST_N */
#ifdef CONFIG_SWB_A22_WLAN
        bt_enabled = 1;
#endif		
    }
...
static void __init bt_power_init(void)
{
	...
	rc = msm_gpios_enable(bt_config_power_off, ARRAY_SIZE(bt_config_power_off)); //lee.eunsuk on -> off
...
int wlan_boot_power(int on)
{
    ...
    printk(KERN_DEBUG "[WLAN] power switch: %d\n", on);

// power init
    vreg_rfrx2 = vreg_get(0, "rfrx2");              //1.8V_A22
    vreg_msmp = vreg_get(0, "msmp");                //2.6V IO
    mpp_16 = 15;
    if (!mpp_16) 
    {
        printk(KERN_ERR "%s: mpp16 get failed\n",  __func__);
    }
    ...
    //VREG_MSMP : 2.6V_MSMP , IO
    rc = vreg_set_level(vreg_msmp, 2600);
    if (!rc) {
        rc = vreg_enable(vreg_msmp);
    }

    //VREG_RFRX2 : 1.8V_A22
    rc = vreg_set_level(vreg_rfrx2, 1800);
    if (!rc) {
        rc = vreg_enable(vreg_rfrx2);
    }

    //VREG_MSME2 : 1.2V_VDD_PM

#ifdef CONFIG_SWB_A22_WLAN
#if (BOARD_VER >= EF12_WS20)
    wlan_1p2V_A23_switch(1);
#endif
#endif
    ...
    // CHIP_PWD_L
    result = mpp_config_digital_out(mpp_16, MPP_CFG(MPP_DLOGIC_LVL_MSMP, MPP_DLOGIC_OUT_CTRL_LOW));
    printk(KERN_DEBUG "%s: CHIP_PWD_L = LOW (result: %d)\n",  __func__, result);
    return 0;        
}
...
int wlan_vbatt_switch(int onoff)
{
    ...
    if(onoff)
    {
        result = mpp_config_digital_out(mpp_14,MPP_CFG(MPP_DLOGIC_LVL_MSMP, MPP_DLOGIC_OUT_CTRL_HIGH));
        printk(KERN_DEBUG "%s: [WLAN]mpp_14 = HIGH (result: %d)\n",  __func__, onoff);
    }
    else
    {
          printk(KERN_DEBUG "%s: [WLAN] bt_enabed = %d \n",  __func__, bt_enabled);
          if((!bt_enabled) && (!wifi_enabled))
          {
              result = mpp_config_digital_out(mpp_14, MPP_CFG(MPP_DLOGIC_LVL_MSMP, MPP_DLOGIC_OUT_CTRL_LOW));
              printk(KERN_DEBUG "%s: mpp_14 = LOW (result: %d)\n",  __func__, onoff);
          }
    }

    printk(KERN_DEBUG "%s: wlan_power = %d\n",  __func__, onoff);
    return 0;
...
int wlan_1p2V_A23_switch(int onoff)
{
    ...
    if(onoff)
    {
        result = gpio_request(109,"1.2V_A23_EN");
        if( result < 0 )
        {
            printk(KERN_ERR "%s: gpio_request return: %d \n",__func__, result);
        }
        else
        {
            gpio_set_value(109,1);
            printk(KERN_DEBUG "%s: [WLAN]gpio_109 = HIGH \n",  __func__);
        }
        gpio_free(109);
    }
    else
    {
          ...
          if((!bt_enabled) && (!wifi_enabled))
          {
              ...
              else
              {
                  ...
                  printk(KERN_DEBUG "%s: [WLAN]gpio_109 = LOW \n",  __func__);
              }
              gpio_free(109);
          }
    }
...
// power on/off
    ...
    {
        //GPIO init
        rc = msm_gpios_enable(wlan_config_power_on, ARRAY_SIZE(wlan_config_power_on));
        if (rc < 0) {
            printk (KERN_ERR "%s: wlan power on gpio config failed: %d\n", __func__, rc);
            return ;
        }    
        ...
        // CHIP_PWD_L
        result = mpp_config_digital_out(mpp_16, MPP_CFG(MPP_DLOGIC_LVL_MSMP, MPP_DLOGIC_OUT_CTRL_HIGH));
        printk(KERN_DEBUG "%s: CHIP_PWD_L = HIGH (result: %d)\n",  __func__, result);
#ifdef CONFIG_SWB_A22_WLAN    
        wifi_enabled = 1;
#endif		
    }
    else
    {
        ...
        //GPIO 
        rc = msm_gpios_enable(wlan_config_power_off, ARRAY_SIZE(wlan_config_power_off));
        if (rc < 0) {
            printk (KERN_ERR "%s: wlan power on gpio config failed: %d\n", __func__, rc);
            return ;
        }    
...
{
    int rc;
  	printk(KERN_DEBUG "[WLAN]Wifi power switch initialized\n");
...
#ifdef PANTECH_POWER_AR6000_MSM    
	msm_wlan_ar6000_pm_device .dev.platform_data = &wlan_power;
#else
   wlan_power(1);
#endif
}
...
#define CMA3000_IRQ		23

static void cma3000_gpio_release(void)
{
	gpio_free(CMA3000_IRQ);
}

static int cma3000_gpio_setup(void)
{
	int rc;
	int irq_pin = CMA3000_IRQ;

	unsigned irq_cfg = GPIO_CFG(irq_pin, 0, GPIO_INPUT, GPIO_NO_PULL, GPIO_2MA);

	rc = gpio_request(irq_pin, "cma3000_irq");
	if (rc) {
		pr_err("gpio_request failed on pin %d (rc=%d)\n", irq_pin, rc);
		goto err_gpioconfig;
	}
...
err_gpioconfig:
	cma3000_gpio_release();
	return rc;
}

static struct cma3000_platform_data cma3000_data = {
	.gpioirq     = CMA3000_IRQ,
	.gpio_setup  = cma3000_gpio_setup,
	.gpio_shutdown = cma3000_gpio_release
};
#endif
static struct i2c_board_info msm_i2c_board_info[] __initdata = {
#ifdef CONFIG_CMA3000
	{
		I2C_BOARD_INFO(CMA3000_NAME, 0x1C),
		.irq           =  MSM_GPIO_TO_INT(CMA3000_IRQ),
		.platform_data = &cma3000_data
	},
#endif
	{
...
#ifdef CONFIG_SKYCAM_MV9337
	{
		I2C_BOARD_INFO("mv9337", 0x50 >> 1),
	},
#endif
#ifdef SKY_USE_HDMI 
	{
		I2C_BOARD_INFO("sky_hdmi_i2c", 0x72>>1),
	},
	{
		I2C_BOARD_INFO("sky_hdmi_ddc", 0xA0>>1),
	},
#endif //SKY_USE_HDMI
        {
                I2C_BOARD_INFO("qt602240-i2c", 0x4A),//cafe2020 qt602240 slave address
        }
...
static struct i2c_board_info i2c_sensor_device[] __initdata = {
	...
	{
		I2C_BOARD_INFO("sensor-bma150", 0x38 >> 1),		// accelerometer sensor
	},
	#endif
       #ifdef CONFIG_SENSORS_YAS529
        {
                I2C_BOARD_INFO("sensor-yas529", 0x2e >> 1),             // magneticfield sensor
        },
        #endif	
	#ifdef CONFIG_SENSORS_GP2AP002S00F
	{
		I2C_BOARD_INFO("sensor-gp2ap002s00f", 0x44),	// proximity sensor
	},	
	#endif
};
#endif
...
#ifdef CONFIG_SKYSND_USE_EXTAMP
static struct i2c_board_info i2c_audio_device[] __initdata = {
	{
		I2C_BOARD_INFO("max9877-amp", MAX9877_SLAVE_ADDR),
	},
};
#endif

#ifdef CONFIG_SKYCAM_MV9335
static struct i2c_board_info msm_i2c_camera_device[] __initdata = {
	{
		I2C_BOARD_INFO("mv9335", 0x50 >> 1),
	},
};
#endif
...
static uint32_t camera_off_gpio_table[] = {
	GPIO_CFG(0,  0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_RESET */
	/* parallel CAMERA interfaces */
	GPIO_CFG(4,  0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D0 */
	GPIO_CFG(5,  0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D1 */
	GPIO_CFG(6,  0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D2 */
	GPIO_CFG(7,  0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D3 */
	GPIO_CFG(8,  0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D4 */
	GPIO_CFG(9,  0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D5 */
	GPIO_CFG(10, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D6 */
	GPIO_CFG(11, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D7 */
	GPIO_CFG(12, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_PCLK */
	GPIO_CFG(13, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_HSYNC */
	GPIO_CFG(14, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_VSYNC */
	GPIO_CFG(15, 0, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_2MA), /* CAM_MCLK */
};

static uint32_t camera_on_gpio_table[] = {
	GPIO_CFG(0,  0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_RESET */
   /* parallel CAMERA interfaces */
   GPIO_CFG(4,  1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D0 */
   GPIO_CFG(5,  1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D1 */
   GPIO_CFG(6,  1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D2 */
   GPIO_CFG(7,  1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D3 */
   GPIO_CFG(8,  1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D4 */
   GPIO_CFG(9,  1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D5 */
   GPIO_CFG(10, 1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D6 */
   GPIO_CFG(11, 1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_D7 */
   GPIO_CFG(12, 0, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_PCLK */
   GPIO_CFG(13, 1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_HSYNC */
   GPIO_CFG(14, 1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA), /* CAM_VSYNC */
   GPIO_CFG(15, 1, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_16MA), /* CAM_MCLK */
};
#else
static uint32_t camera_off_gpio_table[] = {
	/* parallel CAMERA interfaces */
...
#ifdef CONFIG_SKYCAM_MV9337
static struct msm_camera_sensor_flash_data flash_mv9337 = {
           .flash_type = MSM_CAMERA_FLASH_LED,
           .flash_src  = &msm_flash_src
};

static struct msm_camera_sensor_info msm_camera_sensor_mv9337_data = {
           .sensor_name    = "mv9337",
           .sensor_reset   = 28,
           .sensor_pwd     = 0,
           .vcm_pwd        = 0,
           ...
           .resource       = msm_camera_resources,
           .num_resources  = ARRAY_SIZE(msm_camera_resources),
           .flash_data     = &flash_mv9337
};

static struct platform_device msm_camera_sensor_mv9337 = {
           .name      = "msm_camera_mv9337",
           .dev       = {
                     .platform_data = &msm_camera_sensor_mv9337_data,
           },
};
#endif
...
/* ATHENV */
     ...
     * Put it before MMC host controller in worstmsm_sdcc_setup_power case 
     */
...
/* ATHENV */  
...
#ifdef CONFIG_EF12_BOARD
	&android_pmem_mmp_device,	   // 20100826 jjangu_device : MMP_NEX_PMEM
#ifdef SKY_SCREEN_CAPTURE_API
	&android_pmem_ppp_device,	   // 20100113 KSG : PMEM_ADD
#endif
#endif
	&msm_device_nand,
	&msm_device_i2c,
	...
	&msm_batt_device,
#ifdef CONFIG_SKYCAM_MV9337
	&msm_camera_sensor_mv9337,
#endif
#ifdef CONFIG_SKYCAM_MV9335
	&msm_camera_sensor_mv9335,
#endif
};
...
#ifdef CONFIG_EF12_BOARD
	{GPIO_CFG(51, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA), "sdc1_dat_3"},
	{GPIO_CFG(52, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA), "sdc1_dat_2"},
	{GPIO_CFG(53, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA), "sdc1_dat_1"},
	{GPIO_CFG(54, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA), "sdc1_dat_0"},
	{GPIO_CFG(55, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA), "sdc1_cmd"},
...
static uint32_t msm_sdcc_setup_power(struct device *dv, unsigned int vdd)
{
...
#ifdef CONFIG_EF12_BOARD /* KKLIM 20101210 from EF12 */
       extern unsigned int sd_attach_error;
#endif
	...
	if (vdd == 0) {
		...
		if (!vreg_sts) {
//20100429 choiseulkee chg, SDCC VDD always ON & SD_PWR_EN GPIO control
#ifdef CONFIG_EF12_BOARD /* KKLIM 20101210 from EF12 */
                     if (sd_attach_error) {
                            sd_attach_error = 0;
                     } else {
			...
			{
				gpio_set_value(89,0);
				msleep(10);  /* KKLIM 20101113 sandisk */
			}
			gpio_free(89);		
#else
...
#ifdef CONFIG_SKYSDCARD_USE_HWDETECT
	.status_irq	= MSM_GPIO_TO_INT(82),
	.irq_flags      = IRQF_TRIGGER_RISING | IRQF_TRIGGER_FALLING,
#endif
//#ifdef CONFIG_MMC_MSM_SDC1_DUMMY52_REQUIRED /* ATHENV+++ */
	.dummy52_required = 1,
//#endif /* ATHENV--- */
	.msmsdcc_fmin	= 144000,
...
static struct mmc_platform_data qsd8x50_sdc2_data = {
	...
	.mmc_bus_width  = MMC_CAP_4_BIT_DATA,
	.wpswitch	= msm_sdcc_get_wpswitch,
//#ifdef CONFIG_MMC_MSM_SDC2_DUMMY52_REQUIRED /* ATHENV+++ */
	.dummy52_required = 1,
//#endif /* ATHENV+++ */
	.msmsdcc_fmin	= 144000,
	.msmsdcc_fmid	= 25000000,
...
static int mmc_sd_gpio_setup(int onOff)
{
	int gpio_num = 0;
	int rc = 0;
	...
	if ( onOff == 0)
	{
		for ( gpio_num = 51; gpio_num <= 55; gpio_num++)
		{
			rc = gpio_request(gpio_num, "sdcc_vdd");

			if ( rc >= 0)
			{
				if(gpio_tlmm_config(GPIO_CFG(gpio_num, 0, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA), GPIO_ENABLE))
				{
					printk(KERN_ERR "[SKY SDCARD] Failed to configure GPIO(%d)\n",gpio_num);
				}
	...
	else
	{
		for ( gpio_num = 51; gpio_num <= 55; gpio_num++)
		{
			...
			if ( rc >= 0)
			{
				if(gpio_tlmm_config(GPIO_CFG(gpio_num, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA), GPIO_ENABLE))
				{
					printk(KERN_ERR "[SKY SDCARD] Failed to configure GPIO(%d)\n",gpio_num);
				}
			}
...
{
//20100126 choiseulkee chg, use vreg_mmc for sdcc
#ifndef CONFIG_EF12_BOARD
	if (machine_is_qsd8x50_ffa() || machine_is_qsd8x50a_ffa())
...
#else
#ifdef CONFIG_EF12_BOARD
	mmc_sd_gpio_setup(0); /* KKLIM 20101113 */
#endif
...
#ifdef CONFIG_SKYSDCARD_USE_HWDETECT
	if(gpio_request(82, "sdc1_status_irq")){
		printk(KERN_ERR "[SKY SDCARD] failed to request gpio sdc1_status_irq\n");
	}
	if(gpio_tlmm_config(GPIO_CFG(82, 0, GPIO_INPUT, GPIO_PULL_UP, GPIO_2MA), GPIO_ENABLE)){
		printk(KERN_ERR "[SKY SDCARD] Failed to configure GPIO(82) %d\n");
	}
#endif
#ifdef CONFIG_MMC_MSM_SDC1_SUPPORT
...
msm_i2c_gpio_config(int iface, int config_type)
{
	...
	int gpio_sda;
	if (iface) {
#if 0 //20100510 choiseulkee blk, AUX_I2C is not used
		gpio_scl = 60;
		gpio_sda = 61;
#else
		return;
...
#ifdef F_SKYCAM_CUST_I2C_CLK_FREQ
/* You shall write 64KB binary to MV9337 at boot time. If I2C clock is faster
 * than 280KHz, MV9337 have no time to write received data to it's own NAND. */
	.clk_freq = 280000,
#else
	.clk_freq = 100000,
#endif
...
#ifdef CONFIG_EF12_BOARD
// 20100826 jjangu_device : MMP_NEX_PMEM
static unsigned pmem_mmp_size = MSM_PMEM_MMP_SIZE;
static void __init pmem_mmp_size_setup(char **p)
{
	pmem_mmp_size = memparse(*p, p);
}
__early_param("pmem_mmp_size=", pmem_mmp_size_setup);

// 20100113 KSG : PMEM_ADD
#ifdef SKY_SCREEN_CAPTURE_API
static unsigned pmem_ppp_size = MSM_PMEM_PPP_SIZE;
static void __init pmem_ppp_size_setup(char **p)
{
	pmem_ppp_size = memparse(*p, p);
}
__early_param("pmem_ppp_size=", pmem_ppp_size_setup);
#endif
#endif
...
#endif
#ifdef CONFIG_SKYSND_USE_EXTAMP
	i2c_register_board_info(3, i2c_audio_device,
				ARRAY_SIZE(i2c_audio_device));
#endif
#ifdef CONFIG_SKYCAM_MV9335
	i2c_register_board_info(4, msm_i2c_camera_device,
				ARRAY_SIZE(msm_i2c_camera_device));
#endif
...
#ifdef CONFIG_EF12_BOARD
	platform_device_register(&keypad_device_EF10);
#else
...
//--->wkjung
	msm_fb_vreg_config("ruim", 1);
//<---
	pantech_init_misc(); //allydrop build error
...
#ifdef CONFIG_PMIC_VIBRATOR // shpark 100510
	msm_init_pmic_vibrator(); // pmic_vibrator.c
#endif
}
...
static void __init qsd8x50_allocate_memory_regions(void)
{
  ...
  // 20100826 jjangu_device : MMP_NEX_PMEM
	...
	if (size) {
		addr = alloc_bootmem(size);
		android_pmem_mmp_pdata.start = __pa(addr);
		android_pmem_mmp_pdata.size = size;
		pr_info("allocating %lu bytes at %p (%lx physical) for mmp "
			"pmem arena\n", size, addr, __pa(addr));
	}
	...
	if (size) {
		addr = alloc_bootmem(size);
		android_pmem_ppp_pdata.start = __pa(addr);
		android_pmem_ppp_pdata.size = size;
		pr_info("allocating %lu bytes at %p (%lx physical) for ppp "
			"pmem arena\n", size, addr, __pa(addr));
    }
#endif
#endif
