...
//#define MAX_BUFF_NUM 12
#define MAX_BUFF_NUM 2  //20101229 jhsong : av sync
#define RX_MUTE_IN_CALL 1  //20101022 jhsong
#endif
struct audio_buffer {
	dma_addr_t phys;
	void *data;
...
struct audio_client {
#ifdef CONFIG_EF12_BOARD
	struct audio_buffer buf[MAX_BUFF_NUM];
#else
...
#ifdef RX_MUTE_IN_CALL
int q6audio_set_rx_mute_call(int mute);  //20101022 jhsong
#endif
