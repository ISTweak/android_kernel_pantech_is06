...
#define CAD_HW_DEVICE_ID_ASR_HANDSET_MIC	0x26
#define CAD_HW_DEVICE_ID_ASR_HEADSET_MIC	0x27
#endif
...
static struct q6_device_info q6_audio_devices[] = {
	...
	{
//		.id	= ADSP_AUDIO_DEVICE_ID_HANDSET_MIC,
		.id	= ADSP_AUDIO_DEVICE_ID_SPKR_PHONE_MIC,  //20100915 jhsong
		.cad_id	= CAD_HW_DEVICE_ID_ASR_HANDSET_MIC,
		.path	= ADIE_PATH_SPEAKER_TX,
		.rate   = 8000,
		.dir	= Q6_TX,
		.codec	= Q6_ICODEC_TX,
	...
	{
		.id	= ADSP_AUDIO_DEVICE_ID_HEADSET_MIC,
		.cad_id	= CAD_HW_DEVICE_ID_ASR_HEADSET_MIC,
		.path	= ADIE_PATH_HEADSET_MONO_TX,
		.rate   = 8000,
		.dir	= Q6_TX,
		.codec	= Q6_ICODEC_TX,
