...
static unsigned int keypad_row_gpios_EF10[] = { 42, 41, 40 };
static unsigned int keypad_col_gpios_EF10[] = { 33, 32 };

//#define EF10_KEYMAP_INDEX(row, col) ((row)*ARRAY_SIZE(keypad_col_gpios_EF10) + (col))
#define EF10_KEYMAP_INDEX(row, col) ((col)*ARRAY_SIZE(keypad_row_gpios_EF10) + (row))
#define EF10_KEYMAP_SIZE (ARRAY_SIZE(keypad_col_gpios_EF10) * ARRAY_SIZE(keypad_row_gpios_EF10) )

static const unsigned short keypad_keymap_EF10[EF10_KEYMAP_SIZE] = {
	[EF10_KEYMAP_INDEX(0,0)] = KEY_VOLUMEDOWN,
	[EF10_KEYMAP_INDEX(0,1)] = KEY_HOME,
	[EF10_KEYMAP_INDEX(1,0)] = KEY_VOLUMEUP,
	[EF10_KEYMAP_INDEX(1,1)] = KEY_SEARCH,
	[EF10_KEYMAP_INDEX(2,0)] = KEY_HOLD,
#if (MODEL_ID < MODEL_JMASAI)	/* KKLIM 20100927 */
	[EF10_KEYMAP_INDEX(2,1)] = KEY_CENTER
#endif
};
#endif
...
#ifdef CONFIG_EF12_BOARD
/* EF10 keypad platform device information */
static struct gpio_event_matrix_info EF10_keypad_matrix_info = {
	.info.func	= gpio_event_matrix_func,
	.keymap		= keypad_keymap_EF10,
	.output_gpios	= keypad_col_gpios_EF10,
	.input_gpios	= keypad_row_gpios_EF10,
	.noutputs	= ARRAY_SIZE(keypad_col_gpios_EF10),
	.ninputs	= ARRAY_SIZE(keypad_row_gpios_EF10),
	.settle_time.tv.nsec = 40 * NSEC_PER_USEC,
	.poll_time.tv.nsec = 20 * NSEC_PER_MSEC,
	.flags		= GPIOKPF_LEVEL_TRIGGERED_IRQ | GPIOKPF_PRINT_UNMAPPED_KEYS
};

static struct gpio_event_info *EF10_keypad_info[] = {
	&EF10_keypad_matrix_info.info
};

static struct gpio_event_platform_data EF10_keypad_data = {
	.name		= "EF10_keypad",
	.info		= EF10_keypad_info,
	.info_count	= ARRAY_SIZE(EF10_keypad_info)
};

struct platform_device keypad_device_EF10 = {
	.name	= GPIO_EVENT_DEV_NAME,
	.id	= -1,
	.dev	= {
		.platform_data	= &EF10_keypad_data,
	},
};
#endif
