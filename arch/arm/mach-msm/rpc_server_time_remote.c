...
//jjangu_device 20101218 for alarm
...
/* KKLIM 20101109 */
#if (MODEL_ID == MODEL_JMASAI)
extern void rtc_hctosys_alarm(void);
#endif
...
/* KKLIM 20101109 */
#if 0 /*KKLIM 200101126 ฟ๘บน (MODEL_ID == MODEL_JMASAI) */
		rtc_hctosys_alarm();
#else
#if 0       //jjangu_device 20101218 for alarm
		rtc_hctosys();
#else
              getnstimeofday(&ts);
              rtc_hctosys();
