...
// 20100816 yskim added.. wifi_mac_address
#define   NV_VERS_9_2       0x00090002
#define	NV_VERS_R3200	0xf31ab568
#define	NV_VERS_R4050	0x00040001
...
static int msm_nv_init_rpc_ids(unsigned int vers)
{
    ...
    if (vers == NV_VERS_9_2) {
		...
		return 0;
    }  // ~20100816 yskim added.  
	else if (vers == NV_VERS_R4050) {
		nv_rpc_ids.prog			= 0x3000000e;
		nv_rpc_ids.vers_comp	= NV_VERS_R4050;
		nv_rpc_ids.cmd_remote	= 9;
		return 0;
	}
	else if (vers == NV_VERS_R3200) {
		nv_rpc_ids.prog			= 0x3000000e;
		nv_rpc_ids.vers_comp	= NV_VERS_R3200;
		nv_rpc_ids.cmd_remote	= 9;
		return 0;
	}
