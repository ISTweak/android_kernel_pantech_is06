...
#define AUDIO_PANTECH_SET_RX_MUTE_CALL _IOW(AUDIO_IOCTL_MAGIC, 96, unsigned)
#endif

#ifdef FEATURE_PANTECH_ASR_NEW_DEVICE  //20100823 jhsong
#define AUDIO_PANTECH_GET_CUR_ACDB_ID _IOW(AUDIO_IOCTL_MAGIC, 97, unsigned)
#endif

/* EF10 added */
#define AUDIO_SKY_SET_PREAMPGAIN _IOW(AUDIO_IOCTL_MAGIC, 98, unsigned)
#define AUDIO_SKY_SET_AMPVOLUME _IOW(AUDIO_IOCTL_MAGIC, 99, unsigned)
