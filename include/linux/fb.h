...
/* SKY FB Output Switching Setting */
#define FBIO_SKY_SWITCH_OUTPUT 0x4620
#define FBIO_SKY_SCREEN_ONOFF  0x4621
#define FBIO_SKY_INITIALIZE_LCD  0x4622
#define FBIO_SKY_HDMI_ENABLE    0x4623
...
struct fb_ops {
    ...
    /* perform SKY fb specific ioctl (for HDMI/TV-out) - lived 20091201 */
	int (*fb_sky_ioctl)(struct fb_info *info, unsigned int cmd,
			unsigned long arg);
#endif
};
