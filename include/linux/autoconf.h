...
#define CONFIG_ONENAND_MEMORY 1
...
#define CONFIG_SENSORS_GP2AP002S00F 1
#define CONFIG_NEW_LEDS 1
#define CONFIG_UART2DM_CONSOLE 1
...
#define CONFIG_CMDLINE "init=/sbin/init root=/dev/ram rw initrd=0x11000000,16M console=ttyHSL1,115200n8"
