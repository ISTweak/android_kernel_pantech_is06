...
#ifdef CONFIG_EF12_BOARD //20090510 zion90
//20100809 jjangu_device
    ...
    pinfo.bpp = 24;
    pinfo.fb_num = 2;
    //pinfo.clk_rate = 19260000; 
    pinfo.clk_rate = 24576 * 1000 - 500;
	
    pinfo.lcdc.h_back_porch = 8;//81;
    pinfo.lcdc.h_front_porch = 8;//81;
    ...
    pinfo.bpp = 24;
    pinfo.fb_num = 2;
    //pinfo.clk_rate = 24500000; // 26984880 = 60 * (806 + 558)
    pinfo.clk_rate = 24576 * 1000 - 500;
    ...
    pinfo.lcdc.hsync_skew = 0;
#endif
#else  ////#ifdef CONFIG_EF12_BOARD //20090510 zion90
	pinfo.xres = 800;
	pinfo.yres = 480;
	pinfo.type = LCDC_PANEL;
	pinfo.pdest = DISPLAY_1;
	...
	pinfo.lcdc.underflow_clr = 0xff;	/* blue */
	pinfo.lcdc.hsync_skew = 0;
#endif   ////#ifdef FEATURE_EF10_BOARD //20090510 zion90
